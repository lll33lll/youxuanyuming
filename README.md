...
| 域名 | IP 来源 | 说明 |
| --- | --- | --- |
| `cf.223226.xyz` | [ip.164746.xyz](https://ip.164746.xyz/ipTop10.html) Top10 + [CloudFlareYes 电信](https://addressesapi.090227.xyz/ct) + [微测网](https://www.wetest.vip/page/cloudflare/address_v4.html)（初始部署时的三个源） | 官方网段·精选，每 3 小时 |
...
- `cf` 域名的精选源还原为初始部署时的三个（ipTop10 + CloudFlareYes 电信 + 微测网）
